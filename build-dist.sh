...
KASMVNC_OUT="$(nix build --print-out-paths --no-link "path:$SCRIPT_DIR#kasmvnc" | tail -n1)"
KASMVNC_WWW_OUT="$(nix build --print-out-paths --no-link "path:$SCRIPT_DIR#kasmvnc-www" | tail -n1)"
